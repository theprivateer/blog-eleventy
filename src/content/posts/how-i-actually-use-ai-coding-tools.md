...
metadata:
    title: null
    description: 'AI coding tools are useful to me in four specific situations. Here’s how I use them for familiar work, new stacks, prototypes and disposable scripts.'
---
