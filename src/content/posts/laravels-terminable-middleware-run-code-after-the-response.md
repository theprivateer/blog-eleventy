...
metadata:
    title: null
    description: 'Laravel can finish useful work after sending the HTTP response. Here’s how terminable middleware behaves, shares state and fits into the request lifecycle.'
---
