...
intro: null
published_at: 2021-09-08T00:00:00+10:00
category_id: 2
created_at: 2021-09-08T10:00:00+10:00
updated_at: 2026-02-06T16:01:07+10:00
metadata:
    title: null
    description: 'FileMaker’s PHP and FMREST APIs now share one cleaner interface. Here’s the query-builder-style package I made to work with both.'
---
...
try
{
    $command = $fm->newFindCommand('users')
                    ->addFindCriterion('email', '"hello@philstephens.comm"');
...
$user = $fm->layout('users')->where('email', 'hello@philstephens.com')->first();
